...
namespace {
	...
	class View extends \Illuminate\Support\Facades\View{
		 ...
		 */
		 public static function __construct($engines, $finder, $events, $decorator){
			//Method inherited from \Robbo\Presenter\View\Environment
	...
	class LaravelLocalization extends \Mcamara\LaravelLocalization\Facades\LaravelLocalization{
		 ...
		 * @static 
		 */
		 public static function __construct($configRepository, $view, $translator){
			//Method inherited from \Mcamara\LaravelLocalization\LaravelLocalization
			 \Mcamara\LaravelLocalization\LaravelLocalization::__construct($configRepository, $view, $translator);
		 }
		 ...
		 * @static 
		 */
		 public static function localizeURL($url, $locale = null){
			//Method inherited from \Mcamara\LaravelLocalization\LaravelLocalization
		 ...
		 */
		 public static function getLocalizedURL($locale = null, $url = null){
			//Method inherited from \Mcamara\LaravelLocalization\LaravelLocalization
			return \Mcamara\LaravelLocalization\LaravelLocalization::getLocalizedURL($locale, $url);
		 }
		 ...
		 * @static 
		 */
		 public static function getURLFromRouteNameTranslated($locale, $transKeyName = null, $attributes = array()){
			//Method inherited from \Mcamara\LaravelLocalization\LaravelLocalization
		 ...
		 * @static 
		 */
		 public static function getAllowedLanguages($abbr = true){
			//Method inherited from \Mcamara\LaravelLocalization\LaravelLocalization
			return \Mcamara\LaravelLocalization\LaravelLocalization::getAllowedLanguages($abbr);
		 }
		 ...
		 * @static 
		 */
		 public static function getTranslatedRoutes(){
			//Method inherited from \Mcamara\LaravelLocalization\LaravelLocalization
			return \Mcamara\LaravelLocalization\LaravelLocalization::getTranslatedRoutes();
		 }
		 ...
		 */
		 public static function setRouteName($name){
			//Method inherited from \Mcamara\LaravelLocalization\LaravelLocalization
			 \Mcamara\LaravelLocalization\LaravelLocalization::setRouteName($name);
		 }
	...
	class Notify extends \Acme\Facades\Notify{
		 ...
		 * @static 
		 */
		 public static function __construct($blast){
			//Method inherited from \Acme\Notifications\EmailNotifier
			 \Acme\Notifications\EmailNotifier::__construct($blast);
		 }
		 ...
		 * @static 
		 */
		 public static function newsletterSubscribers($data){
			//Method inherited from \Acme\Notifications\EmailNotifier
			 \Acme\Notifications\EmailNotifier::newsletterSubscribers($data);
		 }
	...
	class Basset extends \Basset\Facade{
		 ...
		 */
		 public static function __construct($factory, $finder){
			//Method inherited from \Basset\Environment
