...
return array(
    ...
    */
    ...
    'general'      => [
        ...
        'profile'              => 'معلوماتي',
        'username'             => 'اسم الدخول',
        'name_en'              => 'اسم رباعي بالإنجليزي',
        'name_ar'              => 'اسم رباعي بالعربي',
        'name_msg'             => 'The same name will be used while Issuing your certificate',
        'civilid'              => 'رقم المدني',
        ...
        'settings'             => 'خصائص',
        'address'              => 'عنوان',
        'follow-us'            => 'تابعونا على وسائل التواصل الإجتماعي',
        'courses'              => 'الدورات',
        'coursesgallery'       => 'معرض الدورات',
