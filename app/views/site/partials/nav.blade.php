<div class="navbar navbar-default">
    ...
    <div class="navbar-collapse collapse navbar-responsive-collapse">
        <ul class="nav navbar-nav">
            <li class="{{ (Request::is('en') || Request::is('ar') || Request::is('/')) ? 'active' : '' }}" ><a href="{{ action('HomeController@index') }}">{{ Lang::get('site.nav.home')}}</a></li>
            <li class="{{ (Request::segment('2') == 'course' ? 'active' :  false ) }}"><a href="{{ action('EventsController@index') }}">{{ Lang::get('site.general.courses')}}</a></li>
